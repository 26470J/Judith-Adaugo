...
public class Payment extends TaxAssessment {
    ...
    public void setPaymentDate(String paymentDate) throws TaxDataException {
        if (paymentDate == null || paymentDate.trim().isEmpty())
            throw new TaxDataException("paymentDate cannot be empty");
        this.paymentDate = paymentDate;
    }
